...
export interface ApiFacultyFaculty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    code: Schema.Attribute.Text & Schema.Attribute.Unique;
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Admisi\u00F3n', 'Estudiantes', 'Docentes', 'General']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiImportantDateImportantDate
  extends Struct.CollectionTypeSchema {
  collectionName: 'important_dates';
  info: {
    displayName: 'important-date';
    pluralName: 'important-dates';
    singularName: 'important-date';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Admisi\u00F3n', 'Acad\u00E9mico', 'Administrativo', 'Eventos']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::important-date.important-date'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiProgramProgram extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    level: Schema.Attribute.Enumeration<
      ['Pregrado', 'Postgrado', 'T\u00E9cnico', 'Educaci\u00F3n Continua']
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    audience: Schema.Attribute.Enumeration<
      ['Estudiantes', 'Docentes', 'Graduados', 'P\u00FAblico General']
    >;
    category: Schema.Attribute.Enumeration<
      ['Estudiantes', 'Docentes', 'Administrativo', 'Transparencia']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::important-date.important-date': ApiImportantDateImportantDate;
